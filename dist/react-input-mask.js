  ...
  function (_React$Component) {
    ...
    function InputElement(props) {
      ...
      _this.getInputDOMNode = function () {
        ...
        var input = reactDom.findDOMNode(_assertThisInitialized(_this));
      ...
      _this.setInputValue = function (value) {
        ...
        var r = /[\u0660-\u0669\u06F0-\u06F9]/g;
        _this.value = value.replace(r, function (c) {
      ...
      var _r = /[\u0660-\u0669\u06F0-\u06F9]/g;
      _this.value = _newValue.replace(_r, function (c) {
        return '0123456789'[c.charCodeAt(0) & 0xf];
      });
      return _this;
    }
    ...
    _proto.componentDidUpdate = function componentDidUpdate() {
      ...
      var r = /[\u0660-\u0669\u06F0-\u06F9]/g;
      this.value = newValue.replace(r, function (c) {
        return '0123456789'[c.charCodeAt(0) & 0xf];
      });
